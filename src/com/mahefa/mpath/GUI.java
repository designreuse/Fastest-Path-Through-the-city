...
public class GUI extends javax.swing.JFrame {
    ...
    @SuppressWarnings("unchecked")
        ...
        private void initComponents() {
                ...
                jScrollPane2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Map", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 11), new java.awt.Color(0, 51, 255))); // NOI18N
    ...
    private void butClearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butClearActionPerformed
        ...
        dtm.getDataVector().removeAllElements();
        this.tables.repaint();
	this.comboOrig.removeAllItems();
	this.comboDest.removeAllItems();
    ...
    private void butRenewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butRenewActionPerformed
		...
		JOptionPane.showMessageDialog(this, ""
			+ "If anything is not clear enough, please refer to the "
